...
/**
 * Dependencies:
 * Class.js (John Resig's Simple JavaScript Inheritance)
 * jsTree (www.jstree.com/documentation/core)
 * jqGrid (www.trirand.com/blog)
 * layout.jquery (layout.jquery-dev.net)
 */
define('RepositoryBrowser',
['Class', 'jquery', 'jstree', 'jqgrid', 'jquery-layout'],
function (Class, jQuery) {
	...
	var RepositoryBrowser = Class.extend({
		...
		show: function () {
			...
			// this._fetchRepoRoot(this.jstree_callback);
